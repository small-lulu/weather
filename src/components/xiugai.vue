<template>
  <div>
    <mt-header fixed title="修改信息"></mt-header>
    ...
    <div class="zhuce">
      ...
      <mt-field label="所在城市" placeholder="请输入所在城市" type="tel" v-model="cityname"></mt-field>
      <mt-field label="自我介绍" placeholder="请输入自我介绍" type="textarea" rows="4" v-model="introduction"></mt-field>
    </div>
    <div class="bt">
      <mt-button type="danger" size="small" @click="xiugai">确认修改</mt-button>
      <mt-button type="primary" size="small" @click="go('/minei')">不用修改，谢谢</mt-button>
    </div>
...
//    },
    ...
    methods: {
      ...
      xiugai() {
        ...
        axios.get('http://47.104.109.186:3002/xiugai', {
          params: {
